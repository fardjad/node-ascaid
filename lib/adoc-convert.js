...
const defaultOptions = { safe: "server", doctype: "book", header_footer: true };
...
export const adocConvert = async (adoc, options) => {
  const html = adoctor.convert(adoc, { ...defaultOptions, ...options });
